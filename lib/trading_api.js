...
var TradingAPI = function(params) {
    ...
    this.connect.on(this.protoMessages.getPayloadTypeByName('ProtoOAExecutionEvent'), this.onExecutionEvent.bind(this));

    this.spotSubscriptionMap = {};
    this.connect.on(this.protoMessages.getPayloadTypeByName('ProtoOASpotEvent'), this.onSpotEvent.bind(this));
    this.connect.start();
};
