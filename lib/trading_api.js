...
TradingAPI.prototype.sendMarketOrderRequest = function (accountId, symbolName, tradeSide, volume, accessToken) {
    var ProtoOAOrderType = this.protoMessages.getPayloadTypeByName('ProtoOAOrderType');
    return this.connect.sendGuaranteedCommand(
        this.protoMessages.getPayloadTypeByName('ProtoOACreateOrderReq'),
        {
            accountId: accountId,
...
TradingAPI.prototype.sendSubscribeForTradingEventsRequest = function (accountId, accessToken) {
    return this.connect.sendGuaranteedCommand(
        this.protoMessages.getPayloadTypeByName('ProtoOASubscribeForTradingEventsReq'),
        {
            accountId: accountId,
            accessToken: accessToken
        }
...
// Execution events
TradingAPI.prototype.onExecutionEvent = function (callback) {
    this.connect.on(this.protoMessages.getPayloadTypeByName('ProtoOAExecutionEvent'), callback);
};

// Subscribing for spot prices
TradingAPI.prototype.sendSubscribeForSpotsRequest = function (accountId, symblolName, accessToken) {
    return this.connect.sendGuaranteedCommand(
        this.protoMessages.getPayloadTypeByName('ProtoOASubscribeForSpotsReq'),
        {
            accountId: accountId,
            accessToken: accessToken,
...
TradingAPI.prototype.sendUnsubscribeFromSpotsRes = function () {
    return this.connect.sendGuaranteedCommand(
        this.protoMessages.getPayloadTypeByName('ProtoOAUnsubscribeFromSpotsReq'),
        {}
    );
};

// Spot events
TradingAPI.prototype.onSpotEvent = function (callback) {
    this.connect.on(this.protoMessages.getPayloadTypeByName('ProtoOASpotEvent'), callback);
};
